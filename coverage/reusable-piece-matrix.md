...
verified: "cc719cf4c37337d427360063a55453b97a63d916af3b770ffeef21925d87b4d1"
...
- Applicable piece pairs: 73,378
- Covered piece pairs: 930
...
| `combat` — Combat | 24 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 1,286 |
...
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 5,087 | 2,174 | 2,174 | `absent` | `untested` |
...
| `residual.keyword_dependency.equip` | `keyword_mechanics` | 25 | 13 | 13 | `absent` | `untested` |
