...
verified: "cc2b5f182251e9e0afe8721f381f2b925f540aab968f3e81bea0234664aecc88"
...
- Material abilities classified: 59,216
- Unclassified material spans: 0
- Mapped pinned rules: 1,038 / 3,309
- Applicable piece pairs: 81,348
- Covered piece pairs: 987

## Ontology classes

| Class | Pieces |
|---|---:|
| `actions_permissions` — Actions, permissions, and prohibitions | 91 |
| `card_forms` — Card types and specialized forms | 8 |
| `choices_continuations` — Modes, targets, choices, and continuations | 14 |
| `combat` — Combat | 25 |
| `compiler_cardprogram` — Compiler and CardProgram pieces | 1,445 |
...
| `proposals` — Casting and activation proposals | 30 |
...
|---|---|---:|---:|
| `action_legality_casting_activation_costs_mana` | `inventoried` | 130 | 6 |
...
|---|---|---:|---:|---:|---|---|
| `residual.continuous_layer.continuous-effect-layers-and-dependencies` | `continuous_effects` | 4,542 | 2,024 | 2,024 | `absent` | `untested` |
| `residual.effect_clause.unparsed-clause-grammar` | `one_shot_effects` | 2,037 | 171 | 171 | `absent` | `untested` |
...
| `residual.keyword_dependency.start-your-engines` | `keyword_mechanics` | 40 | 15 | 15 | `absent` | `untested` |
