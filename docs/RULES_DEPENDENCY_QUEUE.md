...
verified: "e71712fbe202ce10c4840492aaad33caa8c0d8aa977896f316282412c2e6e6eb"
...
Source fingerprint: `586585a796f55a8f09d4476b3a92104a689cfe4273e4135f1347f90d91088379`
...
- Selected cross-program work: `bundle:fixed-optional-effect-choices`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | selected | implementation | true | `bundle:fixed-optional-effect-choices` | `compiler_harvest` | 2 | 3 | 98 | 150 | 10.888889 | 0 | 0 |
...
| 8 | blocked | implementation | false | `frontier:continuous_layer:continuous-effect-layers-and-dependencies` | `rules_foundation` | 1 | 0 | 3771 | 8108 | 61.819672 | 0 | 0 |
...
| 26 | blocked | implementation | false | `interaction-implementation:residual.target_or_choice.multiple-damage-recipients` | `rules_foundation` | 1 | 0 | unknown | unknown | unknown | 0 | 0 |
...
| 28 | blocked | implementation | false | `interaction-implementation:residual.target_or_choice.random-outcome` | `rules_foundation` | 1 | 0 | unknown | unknown | unknown | 0 | 0 |
| 29 | blocked | implementation | false | `rules:counter-producer-replacement-closure` | `rules_foundation` | 1 | 0 | unknown | unknown | unknown | 0 | 0 |
| 30 | blocked | implementation | false | `frontier:effect_clause:typed-spell-additional-cost-clause` | `compiler_harvest` | 1 | 3 | 17 | 106 | 0.809524 | 0 | 0 |
| 31 | blocked | implementation | false | `bundle:fixed-exile-contexts` | `compiler_harvest` | 2 | 4 | 0 | 19 | 0.0 | 0 | 0 |
| 32 | blocked | implementation | false | `bundle:fixed-token-creation-contexts` | `compiler_harvest` | 2 | 4 | 0 | 17 | 0.0 | 0 | 0 |
| 33 | blocked | implementation | false | `frontier:effect_clause:unparsed-choose-one` | `compiler_harvest` | 1 | 3 | 0 | 248 | 0.0 | 0 | 0 |

Selected reason: Meets the normal measured complete-card harvest floor and remains behind higher-priority correctness gates. The bundle shares 3 canonical owners across 3 source contexts and is predicted at 10.888889 complete cards per cycle hour.
