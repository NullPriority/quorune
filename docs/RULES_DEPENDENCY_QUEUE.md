...
verified: "d9427dec899b7cf364ae77de5d9d1e4aa207c0ae9e7be54635c75c4ef3049e48"
...
Source fingerprint: `3348650327e503e97b0378472c569e09e90c3e301dcab51ab470d5b213829f2f`
...
- Selected cross-program work: `bundle:fixed-all-damage-prevention-scopes`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | selected | implementation | true | `bundle:fixed-all-damage-prevention-scopes` | `compiler_harvest` | 8 | 4 | 50 | 73 | 8.333333 | 0 | 0 |
...
| 8 | blocked | implementation | false | `frontier:continuous_layer:continuous-effect-layers-and-dependencies` | `rules_foundation` | 1 | 0 | 2495 | 5795 | 40.901639 | 0 | 0 |
...
Selected reason: Meets the normal measured complete-card harvest floor and remains behind higher-priority correctness gates. The bundle shares 7 canonical owners across 4 source contexts and is predicted at 8.333333 complete cards per cycle hour.
