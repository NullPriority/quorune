...
verified: "9e606fdc276ef435cc3587280fdc4d84cd11f8b092eb0fa853638a2920e8e4c2"
...
Source fingerprint: `608e98638eb424bd7c89bd90f364dbc26553c42dea215e346f3508a3fbd6fb19`
...
- Selected cross-program work: `bundle:fixed-restrictive-library-searches`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | selected | implementation | true | `bundle:fixed-restrictive-library-searches` | `compiler_harvest` | 12 | 4 | 98 | 156 | 19.6 | 0 | 0 |
...
| 8 | blocked | implementation | false | `frontier:continuous_layer:continuous-effect-layers-and-dependencies` | `rules_foundation` | 1 | 0 | 2136 | 4949 | 35.016393 | 0 | 0 |
...
| 35 | blocked | implementation | false | `frontier:effect_clause:unparsed-choose-one` | `compiler_harvest` | 1 | 3 | 0 | 209 | 0.0 | 0 | 0 |
...
Selected reason: Meets the normal measured complete-card harvest floor and remains behind higher-priority correctness gates. The bundle shares 6 canonical owners across 4 source contexts and is predicted at 19.6 complete cards per cycle hour.
