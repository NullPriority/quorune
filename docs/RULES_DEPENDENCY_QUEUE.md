...
verified: "7d3ee4eb9e0c28d4202e25bec8c23f82a2905b0d0a3f5d9a1bfd230f58119df9"
...
Source fingerprint: `4b4dbceda9771ec0106a4221df3fc687edcbd65a991cf81028f485836f266637`
...
- Selected cross-program work: `bundle:fixed-casting-surface-closure`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | selected | implementation | true | `bundle:fixed-casting-surface-closure` | `compiler_harvest` | 10 | 2 | 71 | 126 | 8.875 | 0 | 0 |
...
| 8 | blocked | implementation | false | `frontier:continuous_layer:continuous-effect-layers-and-dependencies` | `rules_foundation` | 1 | 0 | 2414 | 5673 | 39.57377 | 0 | 0 |
...
| 32 | blocked | implementation | false | `bundle:fixed-cast-lifecycles` | `compiler_harvest` | 1 | 2 | 25 | 51 | 2.777778 | 0 | 0 |
| 33 | blocked | implementation | false | `bundle:public-static-cast-cost-modifiers` | `compiler_harvest` | 1 | 1 | 16 | 27 | 2.666667 | 0 | 0 |
| 34 | blocked | implementation | false | `frontier:effect_clause:typed-spell-additional-cost-clause` | `compiler_harvest` | 1 | 3 | 18 | 106 | 0.857143 | 0 | 0 |
| 35 | blocked | implementation | false | `bundle:fixed-exile-contexts` | `compiler_harvest` | 2 | 4 | 0 | 19 | 0.0 | 0 | 0 |
| 36 | blocked | implementation | false | `bundle:fixed-token-creation-contexts` | `compiler_harvest` | 2 | 4 | 0 | 17 | 0.0 | 0 | 0 |
| 37 | blocked | implementation | false | `frontier:effect_clause:unparsed-choose-one` | `compiler_harvest` | 1 | 3 | 0 | 236 | 0.0 | 0 | 0 |

Selected reason: Meets the normal measured complete-card harvest floor and remains behind higher-priority correctness gates. The bundle shares 6 canonical owners across 2 source contexts and is predicted at 8.875 complete cards per cycle hour.
