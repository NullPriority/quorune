...
verified: "709f69f5c224f1d092899a5b090c5f0eb5850eadc742082997d2990a80a86d59"
...
Source fingerprint: `fc33c3281098e6bc29d3a6d442f3eca86941cfafecb6200d8c53347d18898bef`
...
- Selected cross-program work: `bundle:fixed-keyword-event-effects`
...
|---:|---|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | selected | implementation | true | `bundle:fixed-keyword-event-effects` | `compiler_harvest` | 2 | 1 | 52 | 86 | 5.777778 | 0 | 0 |
...
| 8 | blocked | implementation | false | `frontier:continuous_layer:continuous-effect-layers-and-dependencies` | `rules_foundation` | 1 | 0 | 1969 | 4393 | 32.278689 | 0 | 0 |
...
Selected reason: Meets the normal measured complete-card harvest floor and remains behind higher-priority correctness gates. The bundle shares 6 canonical owners across 1 source contexts and is predicted at 5.777778 complete cards per cycle hour.
