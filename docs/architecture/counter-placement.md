...
The typed Leveler characteristic owner consumes only the resulting committed
level-counter count; it does not introduce another counter mutation or
replacement path.
