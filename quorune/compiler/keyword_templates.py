...
_KEYWORD_WITH_VALUE = re.compile(
    ...
    r"cumulative upkeep|echo|evolve|fabricate|persist|undying|riot|sunburst|unleash|prowess|afterlife|convoke|affinity|morph|megamorph|disguise|bestow|evoke|flashback|unearth|blitz|buyback|commander ninjutsu|dash|encore|escape|foretell|freerunning|madness|myriad|ninjutsu|plot|prowl|sneak|spectacle|surge|warp|web-slinging|suspend|level up|outlast|reinforce|scavenge)"
    r"(?:\s+(?P<value>.+))?$",
    re.IGNORECASE,
)
