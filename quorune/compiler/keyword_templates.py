...
_KEYWORD_WITH_VALUE = re.compile(
    ...
    r"cumulative upkeep|echo|evolve|fabricate|persist|undying|riot|sunburst|unleash|prowess|afterlife|convoke|affinity|morph|megamorph|disguise|bestow|evoke|flashback|unearth|buyback|dash|escape|foretell|freerunning|madness|plot|prowl|spectacle|surge|warp|suspend|level up|outlast|reinforce|scavenge)"
    r"(?:\s+(?P<value>.+))?$",
    re.IGNORECASE,
)
